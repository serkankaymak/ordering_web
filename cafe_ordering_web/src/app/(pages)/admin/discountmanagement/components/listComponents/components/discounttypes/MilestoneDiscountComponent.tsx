...
interface MileStoneDiscountComponentProps {
...
const MileStoneDiscountComponent: React.FC<MileStoneDiscountComponentProps> = ({
    discount,
...
export default React.memo(MileStoneDiscountComponent);
